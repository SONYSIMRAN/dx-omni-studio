...
import { OMNIDEF } from './caseQuickEntryEnglish_def.js';
import tmpl from './caseQuickEntryEnglish.html';
import tmpl_nds from './caseQuickEntryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseQuickEntryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
