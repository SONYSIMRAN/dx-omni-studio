...
import { OMNIDEF } from './caseWebInquiryEnglish_def.js';
import tmpl from './caseWebInquiryEnglish.html';
import tmpl_nds from './caseWebInquiryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseWebInquiryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
