...
import { OMNIDEF } from './caseCreateEnglish_def.js';
import tmpl from './caseCreateEnglish.html';
import tmpl_nds from './caseCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
