...
import { OMNIDEF } from './integrationAccountDetailsEnglish_def.js';
import tmpl from './integrationAccountDetailsEnglish.html';
import tmpl_nds from './integrationAccountDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class integrationAccountDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
