...
import { OMNIDEF } from './testIntegrationTestEnglish_def.js';
import tmpl from './testIntegrationTestEnglish.html';
import tmpl_nds from './testIntegrationTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testIntegrationTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
