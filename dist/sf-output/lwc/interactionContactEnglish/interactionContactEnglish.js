...
import { OMNIDEF } from './interactionContactEnglish_def.js';
import tmpl from './interactionContactEnglish.html';
import tmpl_nds from './interactionContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class interactionContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
